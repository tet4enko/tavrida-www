...
const component = () => (
    ...
    >
        ...
        <ServicesSlider services={services} type="suvenirka" anchor="suvenirka" />
        <ServiceList services={services} type="suvenirka" anchor="suvenirka" />
        <div
            className={cn({
                [styles.baloon]: true,
                baloon: true,
        ...
        <Head>
            ...
            <meta property="og:description" content="Мы предлагаем услуги по изготовлению футболок, чехлов, кружек, сумок, кепок и др." />
            <meta property="og:url" content="https://tavrida-media.ru/uslugi/suvenirka/" />
